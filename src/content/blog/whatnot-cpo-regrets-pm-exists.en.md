...
1. **The accordion**: pull it open to get strategy and mechanism clear → compress to the smallest V1 and ship → pull it open again to review. Only opening is talk. Only compressing is throwing spaghetti.
2. **Know then go**: think through what explodes if you scale 1,000×, then ship anyway.
3. **Averages lie**: a 3% adoption rate can look like a kill; for one group it may be 100% of the use case. When data and anecdotes collide, he takes Bezos's rule — **believe the anecdote**. Hitting internal goals 50% of the time is enough; assume half your calls are wrong.
...
1. Ask whether you need a PM before you ask who to hire.
2. Do not promote your best IC into a person who only attends meetings.
3. Get into the data and the code yourself — AI has already collapsed the old "ask DS / ask eng for an estimate" gate.
4. Staff to problems, not to a headcount template.
5. Watch for product theater: in a world you can verify, alignment-only value is collapsing.
...
Full notes live in the second brain: `创业商业/Whatnot-CPO后悔产品经理存在-Lenny访谈要点.md`. Original episode: [Lenny's Newsletter](https://www.lennysnewsletter.com/p/this-cpo-regrets-that-product-management) · [YouTube](https://www.youtube.com/watch?v=ruvis-VWg2s).
