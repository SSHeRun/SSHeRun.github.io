...
## 补充：扫地大妈配 Agent，能替代程序员吗？

V2EX 有帖提出一种降本思路：不必招程序员，招普通人，每人配约每月 $1000 的 AI Agent——人负责描述需求、测试与验收，AI 写代码。高级程序员的成本，似乎能换多个「普通人 + Agent」。

来源：[扫地大妈、保安大爷使用 AI Agent，能否替代程序员？](https://www.v2ex.com/t/1243894)

评论区没有顺着降本叙事走，几条高频判断和本文同构：

| 说法（评论区） | 它在钉什么 |
|------|------|
| AI 会自作聪明改文件；外行验不出「是不是自己要的」 | 验收与正确性仍卡在人 |
| 很多人说不清需求；说清楚才是用 AI 的前提 | 杠杆放大的是表达与拆解，不是工牌便宜 |
| 看单位 Token 产出价值；外行往往更费、甚至砸钱也解不了 | 工资差 ≠ 总成本差 |
| 操作员能力 X，用 AI 后的 Y = F(X)；倚天剑在普通人手里打不过张三丰 | Agent 放大已有能力，不是无中生有 |
| 更现实的是「资深的人指挥一堆 Agent」，不是「换成更便宜的人堆更多 Agent」 | 组织形态：10% 强者 + AI，而不是 90% 换人 |
| 小工具「能用」或许行；可维护、可迭代、排障时 AI 死循环仍要经验 | 能跑 ≠ 能长期负责 |

楼主一度把「普通人」澄清成流水线工人、保安（不是产品经理）时，有人直接回：「不是哥们你来真的啊？」——社区默认：认真谈「零基础指挥 Agent 替代程序员」，多半是认知离谱或骗回复。

这和前文并不打架：

- **CRUD / 能被短上下文说清的活**会被 Agent 打穿——「普通人 + Agent」也许能做出能用的小工具。  
- **需求定义、边界、约束、结果评价**仍是稀缺能力——所以放大的是会提问题、会拦偏航、会对产物负责的人，不是把岗位换成更便宜的操作员。  
- 未来更像「AI 驯兽师」指挥多 Agent，而不是「保安大爷订阅 Claude 替代工程团队」。

一句话补钉：**给 100 个人配屠龙刀，未必打得过张三丰；给少数会用剑的人配倚天剑，才可能越级。**
...
- [扫地大妈、保安大爷使用 AI Agent，能否替代程序员？](https://www.v2ex.com/t/1243894)（V2EX）
...
- [[judge-dev-ability-in-ai-era|AI 时代如何判断程序员能力高低]]
